...
void insertionSort(int arr[], int left, int right, bool ascendente) {
    if (!mensajeInsertionsort) {
        cout << "Inicio ordenamiento con inserción "
             << right - left
             << " de tamaño del subarreglo\n";
...
void merge(int arr[], int l, int m, int r, bool ascendente) {
    if (!mensajeMerge) {
        cout << "Inicio ordenamiento con Merge "
             << r - l
...
void timSort(int arr[], int n, bool ascendente) {
    if (!mensajeTim) {
        cout << "Inicio ordenamiento con TimSort "
             << RUN
             << " de tamaño de run\n";
    ...
    cout << "Tiempo de ejecución de TimSort: "
         << duracion.count()
         << " segundos\n";
}
...
void ordenarTimsort() {
    ...
    cout << "Iniciando ordenamiento con Timsort de un arreglo de "
         << tam
         << " tamaño\n";
